...
export const mockProducts: Product[] = [
  ...
  { id: 'p-12', sku: 'RL-TR-001', name: 'Silk Saree — Wedding Collection', category: 'Traditional', brand: 'Reliance', sizes: ['FREE'], colors: ['Red & Gold', 'Royal Blue', 'Emerald'], fabricType: 'Silk', costPrice: 12000, sellingPrice: 19990, stock: 5, lowStockThreshold: 3, status: 'in-stock', image: 'https://images.unsplash.com/photo-1610030469983-98e550d61fb3?w=500&q=80', createdAt: '2026-02-16' },
